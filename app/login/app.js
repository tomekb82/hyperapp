...
const loginPage = state => html`
  <form class="container">
    <div class="form-group">
      ...
      <input oninput=${[UpdateUser, targetValue]} class="form-control" type="text" value=${state.user} />
    </div>
    <div class="form-group">
      <label>Password</label>
      <input oninput=${[UpdatePasswd, targetValue]} class="form-control" type="password" value=${state.passwd} />
    </div>
    <input class="btn btn-success btn-lg" onclick=${preventDefault(LoginSubmit)} type="submit" value="Login" />
  </form>
`;
